  ...
  return (
    <div
      className={cn(
        ...
        variant === 'default' && "",
        variant === 'success' && "border-positive-week bg-positive",
        variant === 'info' && "border-info-week bg-info",
        variant === 'error' && "border-negative-week bg-negative",
        variant === 'warning' && "border-warning-week bg-warning",
        className
      )}
      {...props}
    >
      ...
      <div className="w-full" >
        <h2 className="test-sm lg:text-base font-semibold flex justify-between items-center mb-0.25" >
          {title}
        ...
        <div>
          <p className="text-xs lg:text-sm font-normal" >{subtitle}</p>
          <p
            className={cn(
